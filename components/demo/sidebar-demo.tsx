...
import { BellIcon, HomeIcon, Layers3Icon, SearchIcon, Settings2Icon, SparklesIcon } from "lucide-react";
...
const librarySubItems = [{ label: "Components" }, { label: "Templates" }, { label: "Icons" }];
        ...
        <GlassSidebar collapsible="none" glassVariant={variant} className="w-full rounded-[1.75rem]">
          <SidebarHeader className="gap-2 px-3 pt-3 pb-1.5">
            <div className="flex items-center justify-between gap-3 px-2">
              <div>
                <p className="text-xs tracking-[0.18em] text-black/45 uppercase dark:text-white/45">Workspace</p>
                <h3 className="text-sm font-medium text-black dark:text-white">Aurora</h3>
              </div>
            ...
            <div className="relative">
              ...
              <GlassSidebarInput className="pl-9" placeholder="Search components" />
            </div>
          </SidebarHeader>
                    ...
                    <SidebarMenuSub>
                      {librarySubItems.map((item) => (
                        <SidebarMenuSubItem key={item.label}>
                          <GlassSidebarMenuSubButton>{item.label}</GlassSidebarMenuSubButton>
                        </SidebarMenuSubItem>
                      ))}
                    </SidebarMenuSub>
                  </SidebarMenuItem>
          ...
          <SidebarFooter className="px-3 pt-1.5 pb-3">
            <div className="rounded-2xl border border-white/20 bg-white/18 p-2.5 dark:border-white/10 dark:bg-white/8">
              <p className="text-sm font-medium text-black dark:text-white">Glass Surface</p>
